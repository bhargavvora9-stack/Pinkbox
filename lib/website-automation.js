  ...
  for (const automation of automations || []) {
    ...
    try {
      if (automation.action_type === 'create_notification') {
        ...
        const recipient = order?.customer_email || order?.customer_phone || null;
        ...
        const allowed = ['pending','new','confirmed','processing','packed','shipped','delivered','cancelled','returned','refunded'];
